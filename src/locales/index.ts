const translations = {
  en: {
    ...
    usernameLength: "Must be shorter than 4 and higher than 32 characters.",
  ...
  nl: {
    ...
    usernameEmpty: "Geen gebruikersnaam opgegeven.",
    usernameLength: "Moet korter zijn dan 4 en langer dan 32 karakters.",
